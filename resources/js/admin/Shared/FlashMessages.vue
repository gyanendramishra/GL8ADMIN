<template>
  <div>
    <div v-if="$page.props.flash.success && show" class="full-width flex items-center justify-between bg-green-500 mb-5 rounded">
    ...
    <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show" class="full-width flex items-center justify-between bg-red-400 mb-5 rounded">
      <div class="flex items-center">
